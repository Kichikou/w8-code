...
dataset_dir=/data/Klyck/my-w8-data # 数据集目录，这里是写死的，记得修改
...
# config文件
config=ssd_mobilenet_v1_pets2.config
...
# 导出模型
python ./object_detection/export_inference_graph.py --input_type image_tensor --pipeline_config_path $pipeline_config_path --trained_checkpoint_prefix $train_dir/model.ckpt-200  --output_directory $output_dir/exported_graphs
